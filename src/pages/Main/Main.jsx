...
import background from '../../assets/images/patternpad.png'
const Main = ({ Search }) => {
    const navigate = useNavigate()

    return (
        <div style={{ width: '100vw', height: '100vh', alignItems: 'center', justifyContent: 'center', backgroundImage: `url(${background})` }} className='flex p-5'>
            <form className='lg:w-9/12 sm:w-full'>
                ...
                <div className="relative">
                    ...
                    <button onClick={(e) => { e.preventDefault(); navigate('/search') }} className="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                </div>
            </form>
        </div>
    )
